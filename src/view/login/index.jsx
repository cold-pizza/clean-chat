...
function Login(props) {
    ...
    const buttonActiveSwitch = useSelector(
        (state) => state.switchReducer.buttonActiveSwitch
    );
        ...
        <div className="login">
            ...
            <form id="login-form">
                ...
                <button
                    ...
                    ref={btnRef}
                    style={{
                        background: buttonActiveSwitch ? "#828282" : "#2647ff",
                    }}
                >
                    {buttonActiveSwitch ? "Loading.." : "로그인"}
                </button>
                <button
                    onClick={() => {
